...
async def play(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
                  [[
                      ...
                      InlineKeyboardButton("• Cʜᴀɴɴᴇʟ", url=f"https://t.me/Dub_Anime_in_Hindi"),
                      InlineKeyboardButton("• Group", url=f"https://t.me/RG_Anime_Group"),
                  ],[
    ...
    if replied:
        ...
        if len(m.command) < 2:
         await m.reply_photo(
                    ...
                    [
                        [
                            InlineKeyboardButton("~ Channel ~", url=f"https://t.me/Dub_Anime_in_Hindi"),
                            InlineKeyboardButton("~ Support ~", url=f"https://t.me/RG_Anime_Group")
                        ],
                        [
                            InlineKeyboardButton("🗑 Close", callback_data="cls")
                        ]
